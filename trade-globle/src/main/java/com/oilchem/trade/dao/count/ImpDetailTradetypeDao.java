...
import com.oilchem.trade.domain.count.ImpDetailTradetype;
 ...
 */
public interface ImpDetailTradetypeDao extends PagingAndSortingRepository<ImpDetailTradetype, Long>,
        JpaSpecificationExecutor<ImpDetailTradetype> {

    @Modifying
    @Transactional
    @Query(value = " delete from " +
            " t_import_detail_tradetype " +
            "where " +
    ...
    @Query(value = " insert into  " +
            " t_import_detail_tradetype(col_year,col_month,year_month, product_code , product_name ,trade_type, num, unit , money, avg_price) " +
            "select " +
