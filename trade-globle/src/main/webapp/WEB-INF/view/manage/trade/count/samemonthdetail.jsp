...
<head>
    ...
    <script type="text/javascript">
        ...
        function showSMChart() {
            ...
            if(${hhmmssRand eq null || hhmmssRand eq ''}){
                alert('请选择统计条件，生成统计数据，再查看曲线')
                return;
            }
            window.open('${pageContext.request.contextPath}/manage/hchart/showSMChart/' + $('#autoproductCode')
        ...
        <div class="wrapper">
            ...
            <div class="nav-collapse collapse navbar-responsive-collapse">
                <ul class="nav nav-tabs">
                    <li><a href="${pageContext.request.contextPath}/manage/hchart/toSMDetail">同期月明细统计</a></li>
...
<form:form id="form1" modelAttribute="productCount"
           action="${pageContext.request.contextPath}/manage/hchart/SMDetail"
    ...
    &nbsp;&nbsp;
    <input id="chart" type="button" class="btn-small btn-primary" value="查看曲线" onclick="showSMChart()"/>
    <hr/>
